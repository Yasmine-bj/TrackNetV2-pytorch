...
MODEL_PATH = ROOT_DIR / "weights" / "yolo11m.pt"        # <- dossier renommé
...
# ===== Paramètres généraux =====
CONF_THRES = 0.01      # seuil de confiance YOLO
...
# --- nouveaux polygones d’attaque (exemple) -------------------
ATTACK_ZONE_1 = np.array([[911, 698],[1207, 696],[1690, 679],[1554, 453],[1422, 276],[925, 248],[915, 491]], np.int32).reshape((-1,1,2))
ATTACK_ZONE_2 = np.array([[439, 264],[297, 440],[157, 663],[408, 679],[912, 696],[915, 456],[925, 247],[647, 250]], np.int32).reshape((-1,1,2))
...
ATTACK_ZONES = [ATTACK_ZONE_1, ATTACK_ZONE_2, ATTACK_ZONE_3, ATTACK_ZONE_4]
